...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Sponsored Posts by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {title:RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_value}}.to change(SponsoredPost, :count).by(1)
    end

    it "assigns the new sponsored post to @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title:RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_value}
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      new_price = RandomData.random_value
